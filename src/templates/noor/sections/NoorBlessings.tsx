...
export default function NoorBlessings({ family }: Props) {
  ...
  return (
    <section className="noor-section" style={{ padding: '3rem 2rem', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="reveal-hidden" style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.75rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'var(--noor-ink-light)', marginBottom: '1rem' }}>With The Blessings Of</p>
        <h2 className="noor-gold-foil" style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(1.8rem, 5vw, 3rem)', marginBottom: '0.5rem' }}>
          Our Families
        </h2>
        ...
        {family.parents && (
          <div style={{ marginBottom: '4rem' }}>
            <h3 style={{ fontFamily: 'var(--font-sans)', color: 'var(--noor-gold)', fontSize: '0.8rem', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '1.5rem' }}>
